...
export const gccProductPages: GccProductPage[] = [
  ...
  },
  {
    ...
    category: 'Wire Fencing',
    image: product('pvc-coated-chain-link-fence')?.image || '/products/pvc-coated-chain-link-fence/pvc-chain-link-fence-hero.webp',
    productHref: '/products/pvc-coated-chain-link-fence',
    summary:
      'PVC coated chain link fencing combines galvanized steel wire with a protective PVC coating and a woven diamond mesh. It is suitable for industrial, commercial, residential, construction, agricultural, sports and general perimeter applications where visibility, airflow, appearance and economical long-run coverage are required.',
    specs: [
      { label: 'Mesh opening', value: '25 mm to 65 mm; common options include 50 × 50 mm and 25 × 25 mm' },
      { label: 'Wire diameter', value: 'Project-based options from 2.5 mm to 4.75 mm' },
      { label: 'Fence height', value: 'Commonly 2 m to 3.0 m; project heights from 1.0 m to 3.95 m' },
      { label: 'Post system', value: 'GI / PVC-coated posts with top rail or tension wire as required' },
      { label: 'Security options', value: 'Barbed wire or other security toppings where required' },
      { label: 'Installation', value: 'Supply only or supply & installation' },
    ],
    applications: ['Industrial & commercial', 'Construction', 'Agriculture', 'Sports & recreation', 'Residential'],
    benefits: ['Protective PVC coating', 'Good visibility and airflow', 'Flexible diamond-pattern mesh', 'Economical long boundary coverage', 'Clean uniform green appearance'],
    quoteChecklist: ['Fence running length', 'Required height', 'Mesh opening', 'Wire diameter', 'Post and gate requirement', 'Security topping', 'Delivery / installation location'],
