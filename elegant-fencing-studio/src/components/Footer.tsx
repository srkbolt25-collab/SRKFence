...
const productCategories = [
  { label: "Chain Link Fence", to: "/products/chain-link-fence" },
  { label: "Welded Mesh Fence", to: "/products/welded-mesh-fence" },
  { label: "Anti-Climb 358 Fence", to: "/products/anti-climb-358-fence" },
  { label: "Temporary Fence Panels", to: "/products/temporary-fence-panels" },
  { label: "Barbed Wire", to: "/products/barbed-wire" },
  { label: "Razor Wire", to: "/products/razor-wire" },
];
        ...
        <div className="container mx-auto grid gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.4fr_1fr_1fr_1.1fr] lg:px-8 relative">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-white/80 font-medium">
              Dubai/UAE based fencing supplier, contractor, and installation partner for chain link, welded mesh,
              PVC, steel, anti-climb, temporary, barbed wire, razor wire, gates and perimeter security solutions
              across UAE, GCC and Middle East.
            </p>
