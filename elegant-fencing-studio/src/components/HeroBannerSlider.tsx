...
export default function HeroBannerSlider({
  ...
  return (
    <section className="relative w-full bg-white py-3 sm:py-4">
          ...
          <CarouselContent className="ml-0">
            {slides.map((slide, index) => (
              <CarouselItem key={slide} className="pl-0">
                <div className="relative mx-auto h-[170px] w-full overflow-hidden bg-white sm:h-[210px] md:h-[250px] lg:h-[285px] xl:h-[310px]">
                  <Image
                    src={slide}
