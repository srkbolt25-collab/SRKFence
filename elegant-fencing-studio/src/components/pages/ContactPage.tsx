      ...
      <section className="border-b border-border bg-background py-12 md:py-16">
        <div className="container mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground">
            Contact SRK Fence for chain link fence, welded mesh fence, PVC fencing, anti-climb fencing, temporary
            fencing, barbed wire, razor wire, steel fencing, gates, accessories and installation support.
          </p>
        </div>
      </section>
