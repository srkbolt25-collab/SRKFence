...
import { buildItemListSchema, buildWebPageSchema, staticSeoProfiles } from '@/lib/seo';
...
const completedProjects = [
  {
    ...
    year: '2024',
    description: 'High-security perimeter fencing for a data center facility, featuring anti-climb 358 fence, welded mesh panels, secure gates and monitoring-ready layouts.',
    images: [heroFence, metalFence, vinylFence],
    beforeImage: woodFence,
    afterImage: heroFence,
    videoUrl: null,
    client: 'GCC Data Infrastructure Client',
  ...
  {
    id: 2,
    title: 'Residential Community Boundary Fence',
    location: 'Abu Dhabi, UAE',
    category: 'Residential',
    year: '2024',
    description: 'Residential fencing for a villa community using coated mesh, steel gates and privacy-conscious boundary planning.',
  ...
  },
  {
    ...
    year: '2023',
    description: 'Warehouse security fencing with chain link fence, welded mesh zones, vehicle access gates and perimeter control.',
    images: [heroFence, metalFence],
    beforeImage: woodFence,
    afterImage: heroFence,
    videoUrl: null,
    client: 'Logistics Facility Operator',
    testimonial: 'Professional installation and high-quality materials. Our warehouse security has been significantly enhanced.',
  },
  {
    id: 4,
    title: 'School Campus Perimeter Fence',
    location: 'Doha, Qatar',
    category: 'Schools & Public Parks',
    year: '2024',
    description: 'School and public-space fencing with high visibility, safe access points and durable coated fence materials.',
    images: [vinylFence, metalFence],
    beforeImage: woodFence,
    afterImage: vinylFence,
    videoUrl: null,
    client: 'Education Facility Client',
    testimonial: 'The safety-focused design gives us peace of mind while maintaining an open, welcoming environment.',
  },
  {
    id: 5,
    title: 'Oil and Gas Security Perimeter',
    location: 'Dammam, Saudi Arabia',
    category: 'Oil & Gas Sector',
    year: '2023',
    description: 'Oil and gas security fencing with anti-climb mesh, razor wire topping, steel posts, gates and corrosion-resistant coating options.',
    images: [heroFence, metalFence],
    beforeImage: woodFence,
    afterImage: heroFence,
    videoUrl: null,
  ...
  {
    id: 6,
    title: 'Commercial and Industrial Fencing',
    location: 'Muscat, Oman',
    category: 'Commercial & Industrial',
    year: '2024',
    description: 'Commercial perimeter fencing with welded mesh, steel fencing, pedestrian gates and controlled vehicle access.',
    images: [metalFence, vinylFence],
    beforeImage: woodFence,
    afterImage: metalFence,
    videoUrl: null,
  ...
  return (
    <>
      <StructuredData
        data={[
          buildWebPageSchema(
            staticSeoProfiles.projects.title,
            staticSeoProfiles.projects.description,
            '/projects',
            staticSeoProfiles.projects.keywords,
          ),
          buildItemListSchema(
            'SRK Fence project examples',
            completedProjects.map((project) => ({ label: project.title, href: '/projects' })),
          ),
        ]}
      />
      <SiteLayout>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-foreground mb-4">
              Fencing Projects for UAE and GCC Sites
            </h1>
            <p className="text-xl text-muted-foreground">
              Explore security fencing, warehouse fencing, data center fencing, oil and gas fencing, school fencing,
              residential boundary fencing and commercial perimeter examples.
            </p>
          </div>
