...
import CoatingMaterialsHeroSlider from '@/components/pages/CoatingMaterialsHeroSlider';
...
export default function CoatingMaterialsPage() {
  ...
  const slides = (product.imageGallery || []).map((image) => ({ src: image.src, alt: image.alt }));
    ...
    <>
      <StructuredData
        data={[
          ...
          buildServiceSchema(product.h1, product.shortDescription, `/products/${product.slug}`, undefined, getProductKeywordSet(product)),
          buildBreadcrumbSchema([
            { label: 'Home', href: '/' },
          ...
          <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-14">
            <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center">
              <div className="space-y-6">
                ...
                <div>
                  <p className="mb-3 text-sm font-bold uppercase tracking-[0.2em] text-primary">{product.category}</p>
                  <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl">{product.h1}</h1>
                </div>
                <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">{product.shortDescription}</p>
                <p className="max-w-2xl text-base leading-relaxed text-muted-foreground">{product.intro}</p>
              ...
              <CoatingMaterialsHeroSlider slides={slides} />
            </div>
          </div>
        </section>
        ...
        <section className="bg-background py-16 lg:py-20">
          <div className="container mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
            <Card className="rounded-lg border-border">
              <CardHeader>
                <CardTitle className="text-2xl">Available Coating Options</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="rounded-lg border-border">
              ...
              <CardContent className="space-y-5">
                <p className="text-base leading-relaxed text-muted-foreground">
                  SRK Fence supplies coating materials for fencing products and steel components across UAE and GCC markets.
                  We support project buyers who need coating systems for chain-link fence, welded mesh, fence posts, gates,
                  wires and steel structures, with options based on corrosion resistance, finish appearance, weather exposure
                  and project specification.
                </p>
                <p className="text-base leading-relaxed text-muted-foreground">
                  Supply support is available for contractors, fabricators, distributors and project teams in UAE, Bahrain,
                  Qatar, Kuwait, Saudi Arabia, Iraq, Oman and Jordan. Buyers can request quotations based on coating type,
                  colour, finish, thickness, quantity, exposure conditions and delivery location.
                </p>
        ...
        <section className="bg-background py-16 lg:py-20">
          <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 text-center">
              ...
              <p className="mt-3 text-muted-foreground">Common buyer questions about coating materials for fencing products and steel components.</p>
            </div>
